...
*/
         ...
         */
        //String jpaqlString = "select c from com.hamid.entity.Users c where c.nome_utente = :Admin " ;
        //TypedQuery<com.hamid.entity.Users> query = em.createQuery(jpaqlString, com.hamid.entity.Users.class);
        ...
        //List<com.hamid.entity.Users> customers = query.setParameter("nome_utente", "thing").getResultList();
        ...
        //Query nativeSQLExQuery = em.createNativeQuery(nativeSQLEx, com.hamid.entity.Users.class);
        ...
        CriteriaQuery<com.hamid.entity.Users> qdef = cb.createQuery(com.hamid.entity.Users.class);
        Root<com.hamid.entity.Users> u = qdef.from(com.hamid.entity.Users.class);
        qdef.select(u)
        .where(cb.equal(u.get("xx"),
        cb.parameter(String.class,"xx")))
        .orderBy(cb.asc(u.get("azienda_id")));
        //build query from criteria definition
        TypedQuery<com.hamid.entity.Users> query = em.createQuery(qdef);
        ---------------Explain--------------
...
/*
        ...
        for (Object[] o : students) {
            System.out.println("com.hamid.entity.Users :{ " + " Admin Id : " + o[0] + " UserName : " + o[1] + " Id_User: " + o[2] + " azienda_id_mmas : " + o[3] + " rouolo_id : " + o[4] + " ruolo: " + o[5] +  " }" );
        }
*/
